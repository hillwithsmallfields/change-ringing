...
* none of the practices you can get to have enough ringers who can ring those methods with you
...
participation.  This means that there may not be people at the sessions who can
...
priority the learners give to the methods they want to learn will be represented by a
more negative number for their higher-priority methods.

The software filters out any methods for
which there aren't enough people signed up to make a band.
...
from users indicating whether they think they succeeded, or from
...
ringing a lead successfully or failing to do so.  Setting the lower
threshold to zero, and the upper threshold very high, will force it to
place only one learner in each band.
